...
def run_training(args, train_data):
    if args.model in ['codet5-base']:
        model_path = args.model_path if args.model_path is not None else 'Salesforce/codet5-base'        
...
if __name__ == "__main__":
    from configs.train_critic_configs import *
